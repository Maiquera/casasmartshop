...
<body class="bg-blue-100 text-slate-800 antialiased flex flex-col min-h-screen">
    ...
    <main class="flex-grow max-w-6xl mx-auto px-4 py-2 w-full">
        @yield('content')
    </main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <p class="text-[11px] leading-relaxed text-slate-400">
                        A Casa Smart Shop participa do Programa de Associados da Amazon. Ao comprar através dos links
                        indicados em nosso site, podemos receber uma comissão sem qualquer custo adicional para você.
                    </p>
                </div>
            </div>
